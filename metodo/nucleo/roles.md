---
descripcion: "Los dos roles de Mycelia, ninguno manda: bibliotecario (jardinero a posteriori) y verificador (contrasta, no asigna)"
capa: metodo
tipo: guia
estado: vigente
autor: NEOCAM
