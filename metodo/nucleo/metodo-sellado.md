...
- Promover propuesta a norma = editar núcleo + tag nuevo + actualizar `sealed_ref`: **solo la dirección**. El orden importa: primero existe el tag, después se declara vigente.
